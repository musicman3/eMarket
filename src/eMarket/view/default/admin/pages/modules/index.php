                                                ...
                                                <tr class="<?php echo $eMarket->active($key) ?>">
                                                    ...
                                                    <td>
                                                        <div class="gap-2 d-flex justify-content-end">
                                                            <button type="button" onClick='location.href = "?route=modules/edit&type=<?php echo $type ?>&name=<?php echo $key ?>"' class="btn btn-primary btn-sm bi-pencil-square"></button>
                                                            <form id="form_delete<?php echo $type . '_' . $key ?>" name="form_delete" action="javascript:void(null);" enctype="multipart/form-data">
                                                                ...
                                                                <button type="button" name="delete_but" class="btn btn-primary btn-sm bi-trash" onclick="Confirmation.del('<?php echo $type . '_' . $key ?>', '?route=modules&active=<?php echo $type ?>')"></button>
                                                            </form>
                                                        </div>
                                                    </td>
                                                </tr>
                                        ...
                                        foreach ($_SESSION['MODULES_INFO'][$type] as $key) {
                                            if (!in_array($key, Modules::$installed_filter)) {
                                                ...
                                                <tr class="<?php echo $eMarket->active($key) ?> align-middle">
                                                    ...
                                                    <td>
                                                        <div class="gap-2 d-flex justify-content-end">
                                                            <form id="form_add_<?php echo $type . '_' . $key ?>" name="form_add" action="javascript:void(null);" onsubmit="Ajax.callAdd('form_add_<?php echo $type . '_' . $key ?>', '?route=modules&active=<?php echo $type ?>')" enctype="multipart/form-data">
