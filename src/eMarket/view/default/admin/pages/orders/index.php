                    ...
                    <tbody>
                        <?php for (Pages::$start; Pages::$start < Pages::$finish; Pages::$start++, Pages::lineUpdate()) { ?>
                            <tr class="align-middle">
                                ...
                                <td>
                                    <div class="gap-2 d-flex justify-content-end">
                                        <button onclick="Orders.request('<?php echo Pages::$table['line']['uid'] ?>')" type="submit" class="btn btn-danger btn-sm bi-file-pdf-fill"> <?php echo lang('orders_blanks_invoice_title') ?></button>
