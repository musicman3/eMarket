        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNavDropdown">
            ...
            <ul id="right_bar" class="navbar-nav">
                ...
                if (CatalogAuthorize::$customer == FALSE) {
                    ...
                    <li class="nav-item dropdown"><a href="/?route=contacts" class="nav-link bi-send"><span class="d-inline d-md-none d-lg-inline"> <?php echo lang('contacts_name') ?></span></a></li>
                <?php } else { ?>
