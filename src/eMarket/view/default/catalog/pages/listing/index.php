...
if (Valid::inGET('category_id')) {
    ...
    if (Valid::inGET('search')) {
        ...
        <h1><?php echo lang('listing_search'); ?></h1><?php } else { ?><h1><?php echo Listing::$categories_name ?></h1><?php } ?>
        ...
        <div class="container-fluid">
            <div class="row">
                <div id="listing-block" class="mb-3 p-3 border rounded">
                    <?php echo Listing::$categories_description ?>
                </div>
            </div>
        </div>
        <?php
                ...
                for (Pages::$start;
                    ...
                    <div class="item mb-3 col-xl-4 col-lg-4 col-md-6 col-12 grid-group-item">
                        <div class="cards card border rounded p-2 h-100">
                            ...
                            <?php if (Pages::$table['line']['price'] > 0) { ?>
                                <div class="h-25">
                                    <div class="mb-2 buttons-block text-end d-flex justify-content-center align-items-center h-100 w-100 d-grid gap-1">
