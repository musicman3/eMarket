...
class AboutUs {
    ...
    init() {
        ...
        if (json_data.id === 'undefined' || json_data.length === 0) {
            document.querySelector('#edit').value = '';
            document.querySelector('#add').value = 'ok';
        } else {
            AboutUs.getImageToEdit(json_data.logo_general, JSON.parse(json_data.logo), 'about_us');
