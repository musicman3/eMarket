...
/* =-=-=-= Copyright © 2018 eMarket =-=-=-=
  ...
  =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= */
$resize_max = json_encode(\eMarket\Core\Images::imgResizeMax(eMarket\Admin\Shipping::$resize_param));
?>
...
<!-- Main Class -->
<script type="text/javascript" src="/js/structure/admin/pages/shipping/main.js"></script>
