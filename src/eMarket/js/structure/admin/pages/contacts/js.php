...
/* =-=-=-= Copyright © 2018 eMarket =-=-=-=
  ...
  =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= */
$resize_max = json_encode(\eMarket\Core\Images::imgResizeMax(eMarket\Admin\Contacts::$resize_param));
?>
...
<!-- Main Class -->
<script type="text/javascript" src="/js/structure/admin/pages/contacts/main.js"></script>
