...
CREATE TABLE emkt_contacts (language varchar(64),logo json,logo_general varchar(128),status int,description text,PRIMARY KEY (language)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
