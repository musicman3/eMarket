...
$repo_init = [
    ...
    'release_php_version' => '8.3', // Min Release php version
    'master_php_version' => '8.3', // Min Master php version
...
$removing_list = [
    ...
    '/language/russian/',
    '/model/',
    '/modules/discount/sale/',
    '/modules/payment/cash/',
    '/modules/providers/bulksms/',
    '/modules/providers/smsc/',
    '/modules/shipping/free/',
    '/modules/tabs/reviews/',
