                ...
                $('#fileupload-add, #fileupload-edit').fileupload({
                    ...
                    dataType: 'json',
                        ...
                        $.each(data.result.files, function (index, file) {
                            ...
                            $('<span class="file-upload" id="image_add_new_' + basename + '"/>').html('<div class="holder"><img src="/downloads/upload_handler/files/thumbnail/' + file.name + '" class="thumbnail" /><div class="block"><button class="btn btn-primary btn-xs" type="button" name="deleteImageAddNew_' + basename + '" onclick="deleteImageAddNew(\'' + file.name + '\', \'' + basename + '\')"><span class="glyphicon glyphicon-trash"></span></button></div></div>').appendTo('#logo-add'); // Вставляем лого
