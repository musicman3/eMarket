...
DROP TABLE IF EXISTS emkt_adress_card;
CREATE TABLE emkt_adress_card (
	id int NOT NULL,
	name varchar(256),
	language varchar(64),
        adress varchar(2048),
        default_adress int NOT NULL,
...
INSERT INTO emkt_products (id, name, description, language, status, parent_id, logo, logo_general, date_added, last_modified, keyword, tags, price, currency, tax, quantity, unit, model, date_available, manufacturer, barcode, barcode_value, vendor_code, vendor_code_value, weight, weight_value, min_quantity, dimension, lenght, width, height, type, ordered, viewed, download_file, downloads_stat, sale) VALUES
