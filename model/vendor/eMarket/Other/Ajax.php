                        ...
                        $.each(data.result.files, function (index, file) {
                            ...
                            function imgTesting_onload() {
                                ...
                                if (this.height <= resize_max_height - 1 && this.width <= resize_max_width - 1) {
                                    $('#alert_messages').html('<div class="alert alert-danger">ВНИМАНИЕ: Некоторые изображения не добавлены. Как минимум одна из сторон изображения должна соответствовать формату: ' + resize_max_width + 'x' + resize_max_height + '</div>');
                                } else {
