...
$general_temp = parse_ini_file(getenv('DOCUMENT_ROOT') . '/language/' . $DEFAULT_LANGUAGE . '/admin/lang_general.lng', TRUE);
...
foreach ($lang_dir as $lang_name) {
    ...
    if (!in_array($lang_name, array('.', '..', $DEFAULT_LANGUAGE))) {
        ...
        $ini_general = parse_ini_file(getenv('DOCUMENT_ROOT') . '/language/' . $lang_name . '/admin/lang_general.lng', TRUE);
