...
$eMarket = new eMarket\Admin\Units();
?>
<!-- Модальное окно -->
...
<div id="settings_units">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div id="ajax_data" class='hidden' data-jsondata='<?php echo \eMarket\Admin\Units::$json_data ?>'></div>
                    ...
                    <tbody>
                        <?php for (\eMarket\Pages::$start; \eMarket\Pages::$start < \eMarket\Pages::$finish; \eMarket\Pages::$start++, \eMarket\Pages::lineUpdate()) { ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo eMarket\Pages::$table['line']['unit'] ?></td>
                                <?php if (eMarket\Pages::$table['line']['default_unit'] == 1) { ?>
