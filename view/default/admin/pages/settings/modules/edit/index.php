...
<div id="settings_modules" class="container-fluid">
    <div class="panel panel-default">
        ...
        <form id="form_edit" name="form_edit" action="javascript:void(null);" onsubmit="callEdit('?route=settings/modules&active=<?php echo \eMarket\Core\Valid::inGET('type') ?>')" enctype="multipart/form-data">
            <div class="panel-body">
                <input id="edit" type="hidden" name="edit" value="<?php echo \eMarket\Core\Valid::inGET('type') . '_' . \eMarket\Core\Valid::inGET('name') ?>" />
                ...
                <?php require_once (ROOT . '/modules/' . \eMarket\Core\Valid::inGET('type') . '/' . \eMarket\Core\Valid::inGET('name') . '/controller/admin.php'); ?>

            </div>

            <div class="modal-footer">
                <button type="button" onClick='location.href = "?route=settings/modules&active=<?php echo \eMarket\Core\Valid::inGET('type') ?>"' class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-floppy-remove"></span> <?php echo lang('cancel') ?></button>
