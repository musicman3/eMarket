...
<div id="settings_zones">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div id="ajax_data" class='hidden' data-jsondata='<?php echo \eMarket\Admin\Zones::$json_data ?>'></div>
                            ...
                            <tr>
                                <td class="sortleft">
                                    <form method="get">
                                        ...
                                        <input hidden name="zone_id" value="<?php echo eMarket\Core\Pages::$table['line']['id'] ?>">
                                ...
                                <td><?php echo eMarket\Core\Pages::$table['line']['note'] ?></td>
                                <td>
                                    <div class="flexbox">
                                        <div class="b-left">
