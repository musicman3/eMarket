            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">
                        <div class="pull-left"><span class="settings_back"><a class="btn btn-primary btn-xs" href="<?php echo $_SESSION['zone_page'] ?>"><span class="back glyphicon glyphicon-share-alt"></span></a></span><span class="settings_name"><?php echo lang('title_' . $SET->titleDir() . '_index') ?></span></div>
