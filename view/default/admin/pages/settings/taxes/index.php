			...
			<?php for (\eMarket\Pages::$start; \eMarket\Pages::$start < \eMarket\Pages::$finish; \eMarket\Pages::$start++, \eMarket\Pages::lineUpdate()) { ?>
    			<tr>
    			    <td><?php echo eMarket\Pages::$table['line']['name'] ?></td>
                            ...
                            <td class="text-center"><?php echo $value_6[eMarket\Pages::$table['line']['fixed']] ?></td>
                            <td class="text-center"><?php echo $value_4[eMarket\Pages::$table['line']['tax_type']] ?></td>
                            <td class="text-center"><?php echo $zones_names[eMarket\Pages::$table['line']['zones_id']] ?></td>
    			    <td>
    				<div class="flexbox">
