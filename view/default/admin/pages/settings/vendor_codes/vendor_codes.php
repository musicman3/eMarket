...
<?php require_once('modal/vendor_codes_add.php') ?>
...
<?php for ($k; $k < $lines_p; $k++) { // запускаем цикл формирования модальных окон  ?>
    ...
    <?php require($VALID->inSERVER('DOCUMENT_ROOT') . '/view/default/admin/pages/settings/vendor_codes/modal/vendor_codes_edit.php') ?>
                            ...
                            <tr>
                                ...
                                <th>
                                    <form>
                                        ...
                                        <?php } ?>
                                        <div class="right"><button type="submit" class="btn btn-primary btn-xs" action="vendor_codes.php" formmethod="get"><span class="glyphicon glyphicon-chevron-right"></span></button></div>
                                    </form>
                                    ...
                                    <form>
                                        ...
                                        <?php } ?>
                                        <div class="left"><button type="submit" class="btn btn-primary btn-xs" action="vendor_codes.php" formmethod="get"><span class="glyphicon glyphicon-chevron-left"></span></button></div>
                                    </form>
                                ...
                                <tr>
                                    ...
                                    <td class="al-text-w">
                                        <form>
                                            ...
                                            <div class="right">
                                                <button type="submit" name="vendor_code_delete_but" class="btn btn-primary btn-xs" data-toggle="confirmation" data-btn-ok-label="<?php echo $lang['confirm-yes'] ?>" data-btn-cancel-label="<?php echo $lang['confirm-no'] ?>" title="<?php echo $lang['confirm-del'] ?>" action="vendor_codes.php" formmethod="get"><span class="glyphicon glyphicon-trash"> </span></button>
                                            </div>
                                            <div class="left">
