                        ...
                        <div id="<?php echo lang('#lang_all')[0] . $lines[$k][0] ?>" class="tab-pane fade in active">
                            ...
                            <div class="form-group">
                                <div class="input-group has-error">
                                    ...
                                    <input class="input-sm form-control" type="text" name="vendor_code_edit<?php echo lang('#lang_all')[0] ?>" id="vendor_code_edit<?php echo lang('#lang_all')[0] ?>" value="<?php echo $value_edit[0] ?>" />
                                </div>
                            </div>
                        </div>
                            ...
                            for ($xl = 1; $xl < count(lang('#lang_all')); $xl++) {
                                ...
                                <div id="<?php echo lang('#lang_all')[$xl] . $lines[$k][0] ?>" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group has-error">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-sort-by-order"></span></span>
                                            <input class="input-sm form-control" type="text" name="vendor_code_edit<?php echo lang('#lang_all')[$xl] ?>" id="vendor_code_edit<?php echo lang('#lang_all')[$xl] ?>" value="<?php echo $value_edit[$xl] ?>" />
                                        </div>
                                    </div>
                                </div>
