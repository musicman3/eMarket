...
<div id="edit" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form_edit" name="form_edit" action="javascript:void(null);" onsubmit="call_edit('POST')" enctype="multipart/form-data">
                        ...
                        <div id="<?php echo lang('#lang_all')[0] . $modal_id ?>" class="tab-pane fade in active">
                            ...
                            <div class="form-group">
                                <div class="input-group has-error">
                                    ...
                                    <input class="code_edit0 input-sm form-control" type="text" name="vendor_code_edit<?php echo lang('#lang_all')[0] ?>" id="vendor_code_edit<?php echo lang('#lang_all')[0] ?>" />
                                </div>
                            </div>
                        </div>
