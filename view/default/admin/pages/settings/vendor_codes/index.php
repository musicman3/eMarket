...
<div id="ajax">
    <div id="settings_vendor_codes" class="container-fluid">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div id="ajax_data" class='hidden'
                         ...
                         data-vendor='<?php echo $default_vendor_code_edit ?>'
                         ></div>
                                ...
                                <th>
                                    ...
                                    <form>
                                        <?php if (count($lines) > $lines_on_page) { ?>
                                            <input hidden name="route" value="settings/vendor_codes">
                                    ...
                                    <?php } ?>
                                     <td class="al-text-w">
                                        <form id="form_delete<?php echo $lines[$start][0] ?>" name="form_delete" action="javascript:void(null);" onsubmit="callDelete('<?php echo $lines[$start][0] ?>')" enctype="multipart/form-data">
                                            ...
                                            <div class="right">
                                                <button type="submit" name="delete_but" class="btn btn-primary btn-xs" data-toggle="confirmation" data-singleton="true" data-btn-ok-label="<?php echo lang('confirm-yes') ?>" data-btn-cancel-label="<?php echo lang('confirm-no') ?>" title="<?php echo lang('confirm-del') ?>"><span class="glyphicon glyphicon-trash"> </span></button>
                                            </div>
                                        </form>
