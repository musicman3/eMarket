                                ...
                                <tr>
                                    ...
                                    <td class="al-text-w">
                                        <form>
                                            ...
                                            <div class="right">
                                                <button type="submit" name="vendor_code_delete_but" class="btn btn-primary btn-xs" data-toggle="confirmation" data-btn-ok-label="<?php echo $lang['confirm-yes'] ?>" data-btn-cancel-label="<?php echo $lang['confirm-no'] ?>" title="<?php echo $lang['confirm-del'] ?>" action="index.php" formmethod="get"><span class="glyphicon glyphicon-trash"> </span></button>
                                            </div>
                                            <div class="left">
