...
<div id="settings_vendor_codes">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div id="ajax_data" class='hidden' data-jsondata='<?php echo \eMarket\Admin\VendorCodes::$json_data ?>'></div>

            <div class="table-responsive">
                <table class="table table-hover">
                    <thead>
                        <tr>
                            <th colspan="3"><?php echo \eMarket\Core\Pages::counterPage() ?></th>
                    ...
                    <tbody>
                        <?php for (\eMarket\Core\Pages::$start; \eMarket\Core\Pages::$start < \eMarket\Core\Pages::$finish; \eMarket\Core\Pages::$start++, \eMarket\Core\Pages::lineUpdate()) { ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo eMarket\Core\Pages::$table['line']['vendor_code'] ?></td>
                                <?php if (eMarket\Core\Pages::$table['line']['default_vendor_code'] == 1) { ?>
