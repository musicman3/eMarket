...
$eMarket = new eMarket\Admin\OrderStatus();
?>
<!-- Модальное окно -->
...
<div id="settings_order_status">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div id="ajax_data" class='hidden' data-jsondata='<?php echo \eMarket\Admin\OrderStatus::$json_data ?>'></div>

            <div class="table-responsive">
                <table class="table table-hover">
                    <thead>
                        <tr>
                            <th colspan="3"><?php echo \eMarket\Pages::counterPage() ?></th>
                    ...
                    <tbody id="sort-list">
                        <?php for (\eMarket\Pages::$start; \eMarket\Pages::$start < \eMarket\Pages::$finish; \eMarket\Pages::$start++, \eMarket\Pages::lineUpdate()) { ?>
                            <tr class="sort-list" unitid="<?php echo eMarket\Pages::$table['line']['id'] ?>">
                                ...
                                <?php if (eMarket\Pages::$table['line']['default_order_status'] == 1) { ?>
