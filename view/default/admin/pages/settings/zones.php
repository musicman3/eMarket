...
<?php for ($k; $k < $lines_p; $k++) { // запускаем цикл формирования модальных окон  ?>
    ...
    <?php require($VALID->inSERVER('DOCUMENT_ROOT') . '/view/default/admin/pages/settings/modal/zones_edit.php') ?>
                            ...
                            <tr>
                                <th colspan="5">
                                    <?php if ($lines == TRUE) { ?>
                                        ...
                                        ?>
                                        <div class="log-page"><?php echo $lang['no_zones'] ?></div>
                                    <?php } ?>
                                </th>
                                ...
                                <th>
                                    <form>
                                        ...
                                        <?php } ?>
                                        <div class="log-right"><button type="submit" class="btn btn-primary btn-xs" action="/controller/admin/pages/settings/zones.php" formmethod="get"><span class="glyphicon glyphicon-chevron-right"></span></button></div>
                                    </form>
                                    ...
                                    <form>
                                        ...
                                        <?php } ?>
                                        <div class="log-left"><button type="submit" class="btn btn-primary btn-xs" action="/controller/admin/pages/settings/zones.php" formmethod="get"><span class="glyphicon glyphicon-chevron-left"></span></button></div>
                                    </form>
                                ...
                                <tr>
                                    ...
                                    <td class="al-text-w">
                                        <form>
                                            ...
                                            <div class="log-right">
                                                <button type="submit" name="zone_delete_but" class="btn btn-primary btn-xs" data-toggle="confirmation" data-btn-ok-label="<?php echo $lang['confirm-yes'] ?>" data-btn-cancel-label="<?php echo $lang['confirm-no'] ?>" title="<?php echo $lang['confirm-del'] ?>" action="/controller/admin/pages/settings/zones.php" formmethod="get"><span class="glyphicon glyphicon-trash"> </span></button>
                                            </div>
                                            <div class="log-left">
