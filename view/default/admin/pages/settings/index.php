                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="settings"><a href="currencies/" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-euro glyph-xs"> </span></a><?php echo lang('title_currencies_index') ?></div>
                                </td>
                                <td>
