                            ...
                            <tr>
                                <td class="sortleft">
                                    <form>
                                        ...
                                        <input hidden name="country_id" value="<?php echo eMarket\Core\Pages::$table['line']['id'] ?>">
                                ...
                                <td class="text-center"><?php echo eMarket\Core\Pages::$table['line']['alpha_2'] ?></td>
                                <td class="text-center"><?php echo eMarket\Core\Pages::$table['line']['alpha_3'] ?></td>
                                <td class="text-center"><img src='/view/<?php echo \eMarket\Core\Settings::template() ?>/admin/images/worldflags/<?php echo strtolower(eMarket\Core\Pages::$table['line']['alpha_2']) ?>.png'></td>
                                <td>
                                    <div class="flexbox">
                                        <div class="b-left">
