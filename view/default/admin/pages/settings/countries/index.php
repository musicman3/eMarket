...
<div id="settings_countries" class="panel panel-default">
	...
	<div class="table-responsive">
		...
		<tbody>
		    <?php for ($start; $start < $finish; $start++) { ?>
    			...
    			<td class="text-center"><img src='/view/<?php echo \eMarket\Set::template() ?>/admin/images/worldflags/<?php echo strtolower($lines[$start][2]) ?>.png'></td>
    			<td>
    			    <div class="flexbox">
