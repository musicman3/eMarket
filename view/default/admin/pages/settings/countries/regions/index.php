...
<div id="settings_countries_regions">
	...
	<div class="panel-heading">
		...
		<span class="settings_back"><button type="button" onClick='location.href = "<?php echo $_SESSION['country_page'] ?>"' class="btn btn-primary btn-xs"><span class="back glyphicon glyphicon-share-alt"></span></button></span><span class="settings_name"><?php echo \eMarket\Core\Settings::titlePageGenerator() ?></span>
	    </h3>
	</div>
	<div class="panel-body">

	    <!--Скрытый div для передачи данных-->
            <div id="ajax_data" class='hidden' data-jsondata='<?php echo \eMarket\Admin\Regions::$json_data ?>'></div>
		...
		<table class="table table-hover">
			...
			<?php for (\eMarket\Core\Pages::$start; \eMarket\Core\Pages::$start < \eMarket\Core\Pages::$finish; \eMarket\Core\Pages::$start++, \eMarket\Core\Pages::lineUpdate()) { ?>
    			<tr>
    			    ...
    			    <td class="text-center"><?php echo eMarket\Core\Pages::$table['line']['region_code'] ?></td>
    			    <td>
    				<div class="flexbox">
