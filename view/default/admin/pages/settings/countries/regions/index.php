            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <div class="pull-left"><a class="btn btn-primary btn-xs" href="<?php echo $_SESSION['country_page'] ?>"><span class="back glyphicon glyphicon-share-alt"></span></a> <?php echo lang('title_regions_index') ?></div>
