...
// *************************************//
require($VALID->inSERVER('DOCUMENT_ROOT') . '/controller/admin/pages/settings/countries/modal/countries_edit.php');

?>

<!-- Модальное окно "Изменить" -->
<div id="countries_edit<?php echo $lines[$k][0] ?>" class="modal fade" tabindex="-1">
...
<script type="text/javascript" language="javascript">
    function call_countries<?php echo $lines[$k][0] ?>() {
