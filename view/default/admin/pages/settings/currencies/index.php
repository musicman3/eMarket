		...
		<table class="table table-hover">
			...
			<?php for ($start; $start < $finish; $start++) { ?>
    			<tr>
    			    ...
    			    <td class="text-center"><?php echo $lines[$start]['code'] ?></td>
    			    <td class="text-center"><?php echo $lines[$start]['iso_4217'] ?></td>
    			    <td class="text-center"><?php echo (float) $lines[$start]['value'] ?></td>
				<?php if ($lines[$start]['default_value'] == 1) { ?>
