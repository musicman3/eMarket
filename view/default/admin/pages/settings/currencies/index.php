...
/* =-=-=-= Copyright © 2018 eMarket =-=-=-=  
  ...
  =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= */
use \eMarket\Core\{Messages, Pages, Valid, Settings};
...
<div id="settings_currencies">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div id="ajax_data" class='hidden' data-jsondata='<?php echo Currencies::$json_data ?>'></div>
                    ...
                    <tbody>
                        <?php for (Pages::$start; Pages::$start < Pages::$finish; Pages::$start++, Pages::lineUpdate()) { ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo (float) Pages::$table['line']['value'] ?></td>
                                <?php if (Pages::$table['line']['default_value'] == 1) { ?>
