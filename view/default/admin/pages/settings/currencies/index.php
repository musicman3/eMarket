...
<div id="settings_currencies">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div id="ajax_data" class='hidden' data-jsondata='<?php echo eMarket\Admin\Currencies::$json_data ?>'></div>
                    ...
                    <tbody>
                        <?php for (\eMarket\Core\Pages::$start; \eMarket\Core\Pages::$start < \eMarket\Core\Pages::$finish; \eMarket\Core\Pages::$start++, \eMarket\Core\Pages::lineUpdate()) { ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo eMarket\Core\Pages::$table['line']['iso_4217'] ?></td>
                                <td class="text-center"><?php echo (float) eMarket\Core\Pages::$table['line']['value'] ?></td>
                                <?php if (eMarket\Core\Pages::$table['line']['default_value'] == 1) { ?>
