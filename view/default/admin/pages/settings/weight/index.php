...
$eMarket = new eMarket\Admin\Weight();
?>
<!-- Модальное окно -->
                    ...
                    <tbody>
                        <?php for (\eMarket\Pages::$start; \eMarket\Pages::$start < \eMarket\Pages::$finish; \eMarket\Pages::$start++, \eMarket\Pages::lineUpdate()) { ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo (float) eMarket\Pages::$table['line']['value_weight'] ?></td>
                                <?php if (eMarket\Pages::$table['line']['default_weight'] == 1) { ?>
