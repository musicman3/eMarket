                    ...
                    <tbody>
                        <?php for (Pages::$start; Pages::$start < Pages::$finish; Pages::$start++, Pages::lineUpdate()) { ?>
                            <tr class="align-middle">
                                ...
                                <td>
                                    <div class="gap-2 d-flex justify-content-end">
                                        <button onclick="location.href='/services/jsonrpc/?request=<?php echo JsonRpc::encodeGetData(Pages::$table['line']['uid'], 'Invoice') ?>'" type="submit" class="btn btn-danger btn-sm bi-file-pdf-fill"></button>
