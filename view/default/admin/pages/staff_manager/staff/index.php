...
<div id="staff_manager_staff">
    <div class="card">
        <div class="card-header">
            ...
            <h5 class="card-title">
                <span class="settings_back"><button type="button" onClick='location.href = "<?php echo $_SESSION['staff_manager_page'] ?>"' class="btn btn-primary btn-sm bi-reply"></button></span><span class="settings_name"><?php echo Settings::titlePageGenerator() ?></span>
            </h5>
        </div>
        <div class="card-body">
