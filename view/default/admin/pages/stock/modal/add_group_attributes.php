...
<div id="add_group_attributes" class="modal fade" tabindex="-1">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form id="group_attributes_add_form" class="was-validated">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <div class="input-group input-group-sm">
                            ...
                            <input class="input-add-group-attributes form-control" placeholder="<?php echo lang('name') ?>" type="text" name="group_attributes_<?php echo lang('#lang_all')[0] ?>" required />
                        </div>
                    </div>
                        ...
                        for ($x = 1; $x < Lang::$count; $x++) {
                            ...
                            <div class="mb-3">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input class="input-add-group-attributes form-control" placeholder="<?php echo lang('name') ?>" type="text" name="group_attributes_<?php echo lang('#lang_all')[$x] ?>" required />
                                </div>
                            </div>
