            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="input-group has-success">
                        ...
                        <input class="input-add-attribute input-sm form-control" placeholder="<?php echo lang('name') ?>" type="text" name="<?php echo lang('#lang_all')[0] ?>" required />
                    </div>
                </div>
                    ...
                    for ($x = 1; $x < $LANG_COUNT; $x++) {
                        ...
                        <div class="form-group">
                            <div class="input-group has-success">
                                ...
                                <input class="input-add-attribute input-sm form-control" placeholder="<?php echo lang('name') ?>" type="text" name="<?php echo lang('#lang_all')[$x] ?>" required />
                            </div>
                        </div>
