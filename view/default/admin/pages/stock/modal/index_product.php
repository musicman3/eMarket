                        ...
                        <div id="panel_add_product_2" class="tab-pane fade">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="currency_product_stock" id="currency_product_stock" class="input-sm form-select">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="unit_product_stock" id="unit_product_stock" class="input-sm form-select">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"><span class="bi-building"></span></span>
                                        <select name="manufacturers_product_stock" id="manufacturers_product_stock" class="input-sm form-select">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="tax_product_stock" id="tax_product_stock" class="input-sm form-select">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="vendor_codes_product_stock" id="vendor_codes_product_stock" class="input-sm form-select">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="length_product_stock" id="length_product_stock" class="form-select input-sm ">
                        ...
                        <div id="panel_add_product_5" class="tab-pane fade">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="effect-product" id="effect-product" class="input-sm form-select">
