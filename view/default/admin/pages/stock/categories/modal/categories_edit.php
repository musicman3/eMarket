            ...
            <form id="form_post<?php echo $lines[$i][0] ?>" action="javascript:void(null);" onsubmit="call<?php echo $lines[$i][0] ?>()" method="post" enctype="multipart/form-data">
                <div class="panel-body">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#<?php echo $lang_all[0] . $lines[$i][0]?>"><img src="/view/default/admin/images/worldflags/<?php echo $lang['flag'] ?>.png" alt="<?php echo $lang_all[0] ?>" title="<?php echo $lang_all[0] ?>" width="16" height="10" /> <?php echo $lang_all[0] ?></a></li>
                        ...
                        if (count($lang_all) > 1) {
                            for ($xl = 1; $xl < count($lang_all); $xl++) {
                                ...
                                <li><a data-toggle="tab" href="#<?php echo $lang_all[$xl] . $lines[$i][0]?>"><img src="/view/default/admin/images/worldflags/<?php echo $langx[$xl]['flag'] ?>.png" alt="<?php echo $lang_all[$xl] ?>" title="<?php echo $lang_all[$xl] ?>" width="16" height="10" /> <?php echo $lang_all[$xl] ?></a></li>
