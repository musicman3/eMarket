...
<div id="<?php echo 'addCategory' . $lines[$start][0] ?>" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form_post<?php echo $lines[$start][0] ?>" action="javascript:void(null);" onsubmit="call_edit">
                <div class="panel-body">
                        <input type="hidden" name="parent_id" value="<?php echo $parent_id ?>" />
                        <input type="hidden" name="cat_edit" value="<?php echo $lines[$start][0] ?>" />
                        <div class="form-group">
                            <label><?php echo lang('name') ?>:</label><br>
                            <img src="/view/<?php echo $SET->template() ?>/admin/images/worldflags/ru.png" alt="Russian" title="Russian" width="16" height="10" />Russian<br>
