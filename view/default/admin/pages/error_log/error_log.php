  ...
  <form>
   ...
   <div class="log-left"><button type="submit" class="btn btn-primary btn-xs"  action="/controller/admin/pages/error_log/error_log.php" formmethod="post"><span class="glyphicon glyphicon-chevron-left"></span></button></div>
  	...
  	<form>
		...
		<div class="log-left"><button type="submit" name="log_delete" class="btn btn-primary btn-xs" data-toggle="confirmation" title="<?php echo $lang['button_delete'] ?>" action="/controller/admin/pages/error_log/error_log.php" formmethod="post"><span class="glyphicon glyphicon-trash"> </span></button></div>
	</form>
			</th>
		</tr>
	</thead>
