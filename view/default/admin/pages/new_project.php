...
<table cellspacing="0" style="width: 99%; height: 99%">
	<tbody>
		<tr align="center">
			<td align="center">
				<form action="/controller/admin/process/add_project_complete.php" method="post" accept-charset="utf-8">
					<table cellspacing="0" style="border: 1px solid #62AC04; border-collapse: collapse;">
						<tr>
							...
							<td align="left" style="border: 1px solid #62AC04; padding: 4px;">
								<input type='text' name='project_name' size='25' value='' style='border-radius: 3px;' />
							</td>
						</tr>
						<tr>
							<td align="right" style="border: 1px solid #62AC04; background: #62AC04; color:#ffffff; padding: 4px;">
								<b><?php echo "Статус:" ?></b>
							</td>
							<td align="left" style="border: 1px solid #62AC04; padding: 4px;">
						...
						<tr>
							<td colspan="2" align="center" style="border: 1px solid #62AC04; padding: 4px;">
								<input class="button" type="submit" name="add_project" value="<?php echo $lang['button_add'] ?>" />
							</td>
						</tr>
					</table>
				</form>
