    ...
    <div id="listing" class="contentText">
        <div class="well well-sm">
            <div class="btn-group">
                ...
                &nbsp;&nbsp;<input class="check-box" hidden type="checkbox" data-off-color="danger" data-size="normal" data-label-text="Отобразить" data-label-width='auto' data-on-text="Все" data-off-text="В наличии" data-handle-width="80" name="show_in_stock" id="show_in_stock" type="checkbox"<?php echo $checked_stock ?>>
            </div>
