                ...
                <div class="col-xs-6 text-right">
                    <?php if ($CART->cartProductQuantity($products['id']) > 0) { ?>
                        ...
                        <?php } else { ?>
                            ...
                            <?php if ($CART->cartProductQuantity($products['id']) > 0) { ?>
                                <input id="number_<?php echo $products['id'] ?>" type="number" value="<?php echo $CART->cartProductQuantity($products['id']) ?>" class="quantity" readonly>
                            <?php } else { ?>
                                <input id="number_<?php echo $products['id'] ?>" type="number" value="1" class="quantity" readonly>
                            <?php } ?>
