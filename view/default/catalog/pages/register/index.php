...
<div id="register" class="contentText">
	...
	<fieldset>
		...
		<input type="password" class="form-control" type="password" minlength="7" maxlength="40" placeholder="Введите пароль" id="input-password" value="" name="password" required>
	    </div>
	    <br>
	    <div class="input-group has-error confirm">
		<span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
		<input type="password" class="form-control" type="password" minlength="7" maxlength="40" placeholder="Подтвердите пароль" id="input-confirm" value="" name="confirm" required>
	    </div>
	    <br>
	</fieldset>
