...
$lang_js = json_encode([
    ...
    'product_price' => \eMarket\Core\Ecb::formatPrice(0, 1),
    'total_price_cart_with_sale' => \eMarket\Core\Ecb::formatPrice($INTERFACE->load('priceTerminal', 'data', 'discounted_price'), 1),
