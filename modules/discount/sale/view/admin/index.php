...
<div id="ajax_data" class='hidden' data-jsondata='<?php echo \eMarket\Core\Modules\Discount\Sale::$json_data ?>'></div>
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            for (\eMarket\Core\Pages::$start; \eMarket\Core\Pages::$start < \eMarket\Core\Pages::$finish; \eMarket\Core\Pages::$start++, \eMarket\Core\Pages::lineUpdate()) {
                if (\eMarket\Core\Modules\Discount\Sale::$this_time > eMarket\Core\Pages::$table['line']['UNIX_TIMESTAMP (date_end)']) {
                    $active = ' class="danger"';
                } else {
                    $active = '';
                }
                ...
                <tr<?php echo $active ?>>
                    ...
                    <td class="text-center"><?php echo eMarket\Core\Pages::$table['line']['sale_value'] ?></td>
                    <td class="text-center"><?php echo \eMarket\Core\Settings::dateLocale(eMarket\Core\Pages::$table['line']['date_start']); ?></td>
                    <td class="text-center"><?php echo \eMarket\Core\Settings::dateLocale(eMarket\Core\Pages::$table['line']['date_end']); ?></td>
                    <?php if (eMarket\Core\Pages::$table['line']['default_set'] == 1) { ?>
